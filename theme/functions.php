<?php
/**
 * zakotv functions and definitions
 *
...
if ( ! function_exists( 'omskdev_setup' ) ) :
	...
	function omskdev_setup() {
		 ...
		 * If you're building a theme based on zakotv, use a find and replace
		 * to change 'zakotv' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'zakotv', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'zakotv' ),
			)
		);
...
function omskdev_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'zakotv' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'zakotv' ),
...
function omskdev_scripts() {
	wp_enqueue_style( 'zakotv-style', get_stylesheet_uri(), array(), OMSKDEV_VERSION );
